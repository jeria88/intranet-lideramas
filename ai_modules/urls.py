...
urlpatterns = [
    ...
    path('casos/<int:pk>/eliminar/', views.soft_delete_case, name='soft_delete_case'),
    ...
    path('feedback/piloto/', views.submit_pilot_feedback, name='submit_pilot_feedback'),
    path('<slug:slug>/', views.conversation_list, name='ai_detail'),
